...
pub fn handler() -> impl Fn(tauri::ipc::Invoke<tauri::Wry>) -> bool + Send + Sync + 'static {
    tauri::generate_handler![
        ...
        crate::ssh::commands::ssh_host_key_challenge,
        crate::ssh::commands::ssh_trust_host_key,
        ...
        crate::terminal::docker::container_has_shell,
        ...
        crate::database::import_begin,
        crate::database::import_chunk,
        crate::database::import_finish,
        crate::database::import_abort,
        ...
        crate::credentials::vault::vault_status,
        crate::credentials::vault::vault_unlock,
        crate::credentials::vault::vault_lock,
        crate::credentials::vault::vault_enable,
        crate::credentials::vault::vault_disable,
        crate::credentials::vault::vault_change_password,
        crate::credentials::vault::vault_set_remember,
        crate::credentials::vault::vault_reset,
